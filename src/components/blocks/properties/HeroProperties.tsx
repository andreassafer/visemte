...
import { FormField, Input, Select, InheritSelect, Textarea, ColorSelect, FontSizeSelect, PaddingSelect, CollapsibleSection, FormatButtons } from '@/components/ui'
...
const DEFAULT_LINE1_FONT = { line1FontFamily: '', line1FontSize: '+18', line1FontStyle: '', line1Color: 'fontColor' }
const DEFAULT_LINE2_FONT = { line2FontFamily: '', line2FontSize: '+4',  line2FontStyle: '', line2Color: 'fontColor' }
...
export function HeroProperties({ block, onChange }: Props) {
  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      {/* General */}
      <CollapsibleSection label={t('editor.properties.heroGeneral')} onReset={() => onChange(DEFAULT_GENERAL)} tooltip={resetTooltip} defaultOpen={false}>
      ...
      <CollapsibleSection label={t('editor.properties.sectionFont')} defaultOpen={false}>
        ...
        <CollapsibleSection label={t('editor.properties.heroLine1')} onReset={() => onChange(DEFAULT_LINE1_FONT)} tooltip={resetTooltip} noToggle>

          <FormField label={t('editor.properties.fontFamily')} htmlFor="hero-line1-font">
            <InheritSelect
              id="hero-line1-font"
              value={p['line1FontFamily'] ?? ''}
              onChange={(e) => onChange({ line1FontFamily: e.target.value })}
            >
          ...
          <FormField label={t('editor.properties.fontSize')} htmlFor="hero-line1-size">
            <FontSizeSelect
              ...
              basePx={basePx}
              maxPx={40}
              onChange={(e) => onChange({ line1FontSize: e.target.value })}
            />
          </FormField>
          ...
          <FormField label={t('editor.properties.fontStyle')} htmlFor="hero-line1-fontstyle">
            <InheritSelect
              ...
              onChange={(e) => onChange({ line1FontStyle: e.target.value })}
            >
          ...
          <FormField label={t('editor.properties.fontColorFull')} htmlFor="hero-line1-color">
            <ColorSelect
              ...
              onChange={(v) => onChange({ line1Color: v || undefined })}
            />
          </FormField>
        </CollapsibleSection>

        <CollapsibleSection label={t('editor.properties.heroLine2')} onReset={() => onChange(DEFAULT_LINE2_FONT)} tooltip={resetTooltip} noToggle>

          <FormField label={t('editor.properties.fontFamily')} htmlFor="hero-line2-font">
            <InheritSelect
              id="hero-line2-font"
              value={p['line2FontFamily'] ?? ''}
              onChange={(e) => onChange({ line2FontFamily: e.target.value })}
            >
              <option value="Arial, sans-serif">Arial</option>
              <option value="'Helvetica Neue', Helvetica, sans-serif">Helvetica</option>
              <option value="Georgia, serif">Georgia</option>
          ...
          <FormField label={t('editor.properties.fontSize')} htmlFor="hero-line2-size">
            <FontSizeSelect
              ...
              basePx={basePx}
              onChange={(e) => onChange({ line2FontSize: e.target.value })}
            />
          </FormField>
          ...
          <FormField label={t('editor.properties.fontStyle')} htmlFor="hero-line2-fontstyle">
            <InheritSelect
              ...
              onChange={(e) => onChange({ line2FontStyle: e.target.value })}
            >
              <option value="normal">{t('editor.properties.normal')}</option>
              <option value="bold">{t('editor.properties.bold')}</option>
              <option value="italic">{t('editor.properties.italic')}</option>
          ...
          <FormField label={t('editor.properties.fontColorFull')} htmlFor="hero-line2-color">
            <ColorSelect
              ...
              onChange={(v) => onChange({ line2Color: v || undefined })}
            />
          </FormField>
        </CollapsibleSection>
      ...
      <CollapsibleSection label={t('editor.properties.sectionContent')}>
        ...
        <CollapsibleSection label={t('editor.properties.backgroundImage')} noToggle onReset={() => onChange(DEFAULT_BACKGROUND_IMG)} tooltip={resetTooltip}>
        ...
        {/* Line 1 */}
        <CollapsibleSection label={t('editor.properties.heroLine1')} noToggle onReset={() => onChange({ ...DEFAULT_LINE1_CONTENT, line1Text: t('editor.properties.heroHeadlinePlaceholder') })} tooltip={resetTooltip}>
          <div className="flex flex-col gap-1">
            <div className="flex items-center justify-between">
              <label htmlFor="hero-line1-text" className="text-xs font-medium text-gray-500 dark:text-gray-400">{t('editor.properties.headline')}</label>
              <FormatButtons id="hero-line1-text" onWrap={(v) => onChange({ line1Text: v })} />
            </div>
            <Textarea id="hero-line1-text" value={p['line1Text'] ?? ''} onChange={(e) => onChange({ line1Text: e.target.value })} rows={2} />
          </div>
        </CollapsibleSection>

        {/* Line 2 */}
        <CollapsibleSection label={t('editor.properties.heroLine2')} noToggle onReset={() => onChange({ ...DEFAULT_LINE2_CONTENT, line2Text: t('editor.properties.heroSubheadlinePlaceholder') })} tooltip={resetTooltip}>
          <div className="flex flex-col gap-1">
            <div className="flex items-center justify-between">
              <label htmlFor="hero-line2-text" className="text-xs font-medium text-gray-500 dark:text-gray-400">{t('editor.properties.subheadline')}</label>
              <FormatButtons id="hero-line2-text" onWrap={(v) => onChange({ line2Text: v })} />
            </div>
            <Textarea id="hero-line2-text" value={p['line2Text'] ?? ''} onChange={(e) => onChange({ line2Text: e.target.value })} rows={2} />
          </div>
        </CollapsibleSection>
