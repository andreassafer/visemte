...
const DEFAULT_BORDER     = { secBorderRadius: '', borderWidth: '', borderStyle: '', borderColor: 'borderColor' }
      ...
      <CollapsibleSection label={t('editor.properties.sectionContent')} onReset={() => onChange(DEFAULT_CONTENT)} tooltip={resetTooltip}>
        ...
        <FormField label={t('editor.properties.poster')} htmlFor="vid-thumbnail">
          <Input
            ...
            onChange={(e) => onChange({ thumbnailSrc: e.target.value })}
        ...
        <FormField label={t('editor.properties.playButton')} htmlFor="vid-playbutton">
          <Select
            ...
            onChange={(e) => onChange({ showPlayButton: e.target.value })}
          >
