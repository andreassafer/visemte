...
export function SettingsModal({ onClose }: Props) {
  ...
  const { language, theme, accentColor, setLanguage, setTheme, setAccentColor } = useSettingsStore()
    ...
    >
      <div className="w-full max-w-sm overflow-hidden rounded-xl bg-white shadow-2xl ring-1 ring-gray-200 dark:ring-white/20 dark:bg-gray-900">
        ...
        <div className="flex flex-col gap-6 p-5">
          ...
          <section>
            <h3
              className="mb-2 text-xs font-semibold text-gray-600 dark:text-gray-300 border-l-2 border-gray-400 dark:border-gray-500 pl-1.5"
