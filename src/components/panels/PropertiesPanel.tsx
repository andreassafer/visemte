        ...
        {selectedBlock && selectedChildIndex === null && (
          <>
            {selectedBlock.type === 'text' && (
              <TextProperties block={selectedBlock} onChange={handleChange} />
            )}
            ...
            {selectedBlock.type === 'button' && (
              <ButtonProperties block={selectedBlock} onChange={handleChange} />
            )}
            ...
            {selectedBlock.type === 'columns' && (
              <ColumnsProperties block={selectedBlock} onChange={handleChange} />
            )}
            {selectedBlock.type === 'social' && (
              <SocialProperties block={selectedBlock} onChange={handleChange} />
            )}
            {selectedBlock.type === 'navbar' && (
              <NavbarProperties block={selectedBlock} onChange={handleChange} />
            )}
            {selectedBlock.type === 'hero' && (
              <HeroProperties block={selectedBlock} onChange={handleChange} />
            )}
            {selectedBlock.type === 'video' && (
              <VideoProperties block={selectedBlock} onChange={handleChange} />
            )}
            {selectedBlock.type === 'countdown' && (
              <CountdownProperties block={selectedBlock} onChange={handleChange} />
            )}
            {selectedBlock.type === 'accordion' && (
              <AccordionProperties block={selectedBlock} onChange={handleChange} />
            )}
            {selectedBlock.type === 'quote' && (
              <QuoteProperties block={selectedBlock} onChange={handleChange} />
            )}
          </>
        )}
      </div>
